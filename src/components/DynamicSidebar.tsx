...
export default function DynamicSidebar({ 
  ...
  return (
    <aside className={`${className} bg-white shadow-sm border-r border-gray-200`}>
      {/* 侧边栏头部 */}
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          {!collapsed && (
            <h2 className="text-lg font-semibold text-gray-900">在线考试系统</h2>
          )}
          {onToggle && (
            <button
              onClick={onToggle}
