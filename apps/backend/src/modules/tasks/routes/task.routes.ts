...
router.post(
    '/',
    requireRoleByIds([ROLE_IDS.TEACHER, ROLE_IDS.ADMIN, ROLE_IDS.SUPER_ADMIN]),
    wrap(TaskController.create)
)
...
router.post(
    '/:id/publish',
    requireRoleByIds([ROLE_IDS.TEACHER, ROLE_IDS.ADMIN, ROLE_IDS.SUPER_ADMIN]),
    wrap(TaskController.publish)
)
router.post(
    '/:id/unpublish',
    requireRoleByIds([ROLE_IDS.TEACHER, ROLE_IDS.ADMIN, ROLE_IDS.SUPER_ADMIN]),
    wrap(TaskController.unpublish)
)

router.post(
    '/batch/publish',
    requireRoleByIds([ROLE_IDS.TEACHER, ROLE_IDS.ADMIN, ROLE_IDS.SUPER_ADMIN]),
    wrap(TaskController.batchPublish)
)
router.post(
    '/batch/unpublish',
    requireRoleByIds([ROLE_IDS.TEACHER, ROLE_IDS.ADMIN, ROLE_IDS.SUPER_ADMIN]),
    wrap(TaskController.batchUnpublish)
)
