...
export class LeaderboardController {
  ...
  // 获取排行榜详情和排名数据
  static async getLeaderboardData(req: AuthRequest, res: Response<ApiResponse<{ leaderboard: ILeaderboard; records: ILeaderboardRecord[] }>>) {
    try {
  ...
  // 获取用户在排行榜中的排名
  static async getUserRank(req: AuthRequest, res: Response<ApiResponse<{ rank: ILeaderboardRecord | null; total: number }>>) {
    try {
