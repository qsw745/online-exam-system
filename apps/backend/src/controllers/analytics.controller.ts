  ...
  static async getAnalytics(req: AuthRequest, res: Response) {
    try {
      ...
      const analyticsData = {
        ...
        students: [
          { user_id: 1, username: '张三', total_score: 450, exams_completed: 8, avg_score: 85.2, study_time: 120, last_active: '2024-01-05' },
          { user_id: 2, username: '李四', total_score: 420, exams_completed: 7, avg_score: 82.1, study_time: 105, last_active: '2024-01-04' },
          { user_id: 3, username: '王五', total_score: 380, exams_completed: 6, avg_score: 78.9, study_time: 95, last_active: '2024-01-03' }
        ]
      };
  ...
  static async getKnowledgePoints(req: AuthRequest, res: Response) {
    try {
      ...
      const knowledgePoints = [
        ...
        { id: '5', name: '数据库', questionCount: 22, correctRate: 0.80 }
      ];
...
function getNumberOfDaysInPeriod(period: string): number {
  switch (period) {
    ...
    case '30d': return 30;
    case '90d': return 90;
    case 'all': return 365; // 对于"全部"，我们限制为一年的数据点
    default: return 7;
  }
}
