...
import { Breadcrumb, Card, Pagination, Space, App, Input, Select, DatePicker, Button, Popconfirm } from 'antd'
...
const PublishTaskPage: React.FC = () => {
  ...
  // 列表（默认拉取全部，使用筛选控制 draft/published）
  ...
  return (
    <Space direction="vertical" size={16} style={{ width: '100%' }}>
      <Breadcrumb items={[{ title: '任务管理', href: '/admin/tasks' }, { title: '发布任务' }]} />
      ...
      <Card variant="outlined">
        <TasksTable
          ...
          onDelete={onDelete} // ★ 新增：删除
          showPublishActions // 显示发布/下线操作
        />
